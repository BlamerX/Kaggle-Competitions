"""
================================================================================
BirdCLEF+ 2026 - Inference Script v3 (CPU Only for Submission)
================================================================================

Uses pre-trained probes from GPU training phase.
Runs on CPU within 90-minute Kaggle submission constraint.
Loads all artifacts from single full_perch_arrays.npz file.

Output Files Required from Training:
  - full_perch_arrays.npz    → All models and index arrays
  - full_perch_meta.parquet  → Metadata (optional, for reference)

Features:
- Perch v2 CPU model for test soundscapes
- Trained LR + MLP probes loaded from training artifacts
- Min reduction ensemble (2024 1st place strategy)
- Prior tables for site/hour smoothing
- Efficient batch processing for 90-minute limit
"""
...
print("=" * 70)
print("BirdCLEF+ 2026 - Inference v3 (CPU Submission)")
print("=" * 70)
